...
public class BalloonOverlayView<Item extends OverlayItem> extends FrameLayout {
	...
	public BalloonOverlayView(Context context, int balloonBottomOffset) {
		super(context);
		setupView(context, balloonBottomOffset);
	}
	...
	public void setupView(Context context, int balloonBottomOffset) {
		...
		mTitleTextView = (TextView) v.findViewById(R.id.balloon_item_title);
		mSnippetTextView = (TextView) v.findViewById(R.id.areaTitle);
	...
	public void setData(Item item) {
		...
		if (item.getSnippet() != null) {
			...
			mSnippetTextView.setText(item.getSnippet());
		} else {
