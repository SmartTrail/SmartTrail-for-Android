...
public class AnalyticsUtils {
     ...
     */
    private static final String UACODE = "UA-19717495-3";
        ...
        new AsyncTask<Void, Void, Void>() {
            ...
            protected Void doInBackground(Void... voids) {
                try {
                    ...
                    Log.d(TAG, "GeoZen Analytics trackEvent: "
                            + category + " / " + action + " / " + label + " / " + value);
                } catch (Exception e) {
                    // We don't want to crash if there's an Analytics library exception.
                    Log.w(TAG, "GeoZen Analytics trackEvent error: "
        ...
        new AsyncTask<Void, Void, Void>() {
            ...
            protected Void doInBackground(Void... voids) {
                try {
                    ...
                    Log.d(TAG, "GeoZen Analytics trackPageView: " + path);
                } catch (Exception e) {
                    // We don't want to crash if there's an Analytics library exception.
                    Log.w(TAG, "GeoZen Analytics trackPageView error: " + path, e);
                }
                return null;
            }
        }.execute();
