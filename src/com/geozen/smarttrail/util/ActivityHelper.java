...
import com.geozen.smarttrail.ui.HomeActivity;
...
public class ActivityHelper {
	...
	public boolean onOptionsItemSelected(MenuItem item) {
		...
		case R.id.menu_signout:
			((SmartTrailApplication) mActivity.getApplication()).signoutUser();
			Toast.makeText(mActivity, R.string.signedOut, Toast.LENGTH_SHORT)
					.show();
			goHome();
			return true;
		}
	...
	/**
	 * Invoke "home" action, returning to {@link com.geozen.smarttrail.ui.HomeActivity}
	 * .
	 */
	public void goHome() {
	...
	public void setupActionBar(CharSequence title, int color) {
		...
		SmartTrailApplication app = (SmartTrailApplication) mActivity.getApplication();
	...
	public boolean onPrepareOptionsMenu(Menu menu) {
		...
		for (int i = 0; i < menu.size(); i++) {
			item = menu.getItem(i);
			item = menu.getItem(i).setVisible(false);
			if (item.getItemId() == R.id.menu_signout) {
				item = menu.getItem(i).setVisible(true);
			} else {
				item = menu.getItem(i).setVisible(false);
			}
